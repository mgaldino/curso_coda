...
Essa é o tutorial para o curso de R para análise de políticas públicas. Ao longo do dia iremos:
    ...
    7. Trabalhar problemas do mundo real na parte 2;
    8. Aprender a usar as funções gather() e spread() do tidyr.
